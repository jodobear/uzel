...
def main() -> int:
    ...
    required = [
        ...
        "docs/facts/FACT-009-linux-runner.md",
        "docs/facts/FACT-010-portable-napplets.md",
        "docs/facts/FACT-011-daemon-nmp.md",
        "docs/facts/FACT-012-composed-demo.md",
        "docs/facts/FACT-013-hostile-linux-boundary.md",
        "reports/preflight.md",
        "reports/slice-01-preflight.md",
        "reports/slice-02-preflight.md",
        "reports/slice-03-preflight.md",
        "reports/slice-04-preflight.md",
        "reports/slice-05-preflight.md",
