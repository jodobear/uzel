...
Rounds 24–28 deny destructured constructors, non-freeze `Object` use, raw
`RTCPeerConnection`, parsed DOM, Window event targets, and legacy resource attributes, with probes.
