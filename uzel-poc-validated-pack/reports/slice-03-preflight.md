...
Rounds 24–30 deny destructured constructors, non-freeze `Object` use, raw
`RTCPeerConnection`, parsed DOM, constructed CSS, style mutation, Window event targets, and legacy resource attributes, with probes.
