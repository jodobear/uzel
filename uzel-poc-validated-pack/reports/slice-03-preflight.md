...
Rounds 24–27 deny destructured constructors, non-freeze `Object` use, raw
`RTCPeerConnection`, Window event targets, and legacy resource attributes, with probes.
