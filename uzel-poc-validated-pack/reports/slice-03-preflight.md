...
Rounds 24–29 deny destructured constructors, non-freeze `Object` use, raw
`RTCPeerConnection`, parsed DOM, style mutation, Window event targets, and legacy resource attributes, with probes.
