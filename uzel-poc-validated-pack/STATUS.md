...
hardening/graph chain: 27986c0 -> d80efd4 -> 8df9916 -> 61350a3 -> ed7ba54 -> 8860a6f -> d138b7a -> c379448 -> f9323bb -> 5c45fa6 -> c133560 -> 624b235 -> 1611dcb
current review fix: exact provenance pins, checked temporary-file setup, typed Node trust propagation, focused regressions, and this status travel in one commit; use git rev-parse HEAD after commit for its exact object ID because a commit cannot embed its own resulting SHA
