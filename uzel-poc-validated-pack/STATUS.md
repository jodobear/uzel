...
```text
slice: accepted live-identity and signed-naddr extension; Work 07 active
commits: Uzel PR #8 merged as 1e4cc6abbff4bdded97bfd0b3de4d891f4dee29c; exact reviewed head c6dbc1e2522772e92aac661314be3bc4cadaaa19
...
next action: execute tracker #9 one issue per branch, beginning with #10 on test/ui-acceptance-harness; #11 and #12 may advance as read-only source maps until isolated implementation branches are selected
```
