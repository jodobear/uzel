...
hardening/graph chain: 27986c0 -> d80efd4 -> 8df9916 -> 61350a3 -> ed7ba54 -> 8860a6f -> d138b7a -> c379448 -> f9323bb -> 5c45fa6 -> c133560 -> 624b235 -> 1611dcb -> 97a0232 -> 8423569 -> 040fdb6 -> b015454 -> 777bd30 -> 5045532 -> d8301c1 -> 8b1552d -> b09ac73
current review fix: before STRUCTURE_OK, the shell independently canonicalizes the complete verified-snapshot `.lock` with pinned jq and compares SHA-256 to exact audited constant 1994fc59...c632; deterministic self-consistent fake-Node mutations of source.commit, domains, eventId, and safeAutomation all fail trust before success; sha256sum absence, failure, timeout, malformed/noisy output, and output overflow are bounded infrastructure failures; eventText stays outside the lock digest so harmless signed-event JSON whitespace remains allowed; existing five-file setup and cleanup remain unchanged; focused regressions and this status travel in one commit; use git rev-parse HEAD after commit for its exact object ID because a commit cannot embed its own resulting SHA
