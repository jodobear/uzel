...
| `pablof7z/nampplets` | `jodobear/nampplets:feat/trusted-shell-multi-surface` | `7eccdee76a1afcfc3ff026c8f41b0072a4601840` | focused trusted-shell Node tests; legacy host 4/4 and package 4/4; 22 Python conformance tests; 52-file/211-envelope/10-falsifier baseline; validator, digests, fingerprint, file-growth, AntiSlop, Rust workspace and bindings CI; Codex exact-head review clean after remount-bound and Apple test-path fixes | [jodobear fork PR #1](https://github.com/jodobear/nampplets/pull/1), open; cross-owner PR creation blocked by current fine-grained PAT | Uzel repinned to the exact reviewed fork commit for Slice 05; rerun integrated Linux shell probes and submit the compatibility base before this dependent change upstream |
