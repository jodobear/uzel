...
| `pablof7z/nampplets` | `jodobear/nampplets:feat/identity-cache-refresh` | `20054429624f917f4f0cd2448d9141d7bc114f0e` | retains a configured relay observation after an empty cache frame; remains promptly cancellable; explicitly routes author-bearing identity reads through operator public lanes; file-growth ratchet passes; 18 Python conformance tests; baseline verification; fmt; workspace all-target Clippy with warnings denied; full workspace tests | [jodobear fork PR #4](https://github.com/jodobear/nampplets/pull/4), open | Uzel pins compatibility branch `jodobear/nampplets:uzel/identity-refresh-compat-dd64` at `d533a63d519c14470f900323958509cdea1c6479`; advance only after exact identity, follows, and picture probes pass |
