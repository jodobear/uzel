...
- **Decision:** V-06 now passes. Keep the exact default-deny child CSP and runtime-mediated resource/Nostr providers. This proves feasibility for the tested paths, not every browser API, and does not make the unpublished Kehto commit an accepted source pin.
