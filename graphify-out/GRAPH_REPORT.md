...
## Corpus Check
- 60 files · ~15,159 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 362 nodes · 342 edges · 48 communities (33 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5f536e18`
...
2. `scripts` - 12 edges
3. `Uzel POC agent instructions` - 9 edges
4. `Assumption validation and decision gates` - 9 edges
5. `POC architecture` - 9 edges
6. `Provisional component design` - 9 edges
7. `Gate 0 preflight and Slice 01 decision` - 9 edges
8. `POC scope and acceptance` - 8 edges
9. `Slice 01 preflight` - 8 edges
10. `Work 01 — scaffold` - 8 edges
...
Cohesion: 0.06
Nodes (26): Uzel agent instructions, Development, Uzel, Confidence, Corrections, Diagram review, Gate 0 resolution, POC documentation audit (+18 more)
...
Cohesion: 0.06
Nodes (26): Boundary result, Commands and observed results, Debian probe correction, Fedora probe correction, Locked workspace, Next step, Slice 01 preflight, Verdict (+18 more)
...
Cohesion: 0.09
Nodes (21): dependencies, svelte, devDependencies, svelte-check, @sveltejs/vite-plugin-svelte, typescript, vite, name (+13 more)
...
## Knowledge Gaps
- **241 isolated node(s):** `name`, `private`, `version`, `type`, `dev:web` (+236 more)
