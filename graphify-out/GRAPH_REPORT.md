...
Cohesion: 0.25
Nodes (7): Active issue — #10, Entry evidence, Exit rule, Goal, Parallel issue — #21 data-only corpus, Work 07 — issue-driven stabilization, Work graph

## Knowledge Gaps
- **430 isolated node(s):** `name`, `private`, `version`, `type`, `dev:web` (+425 more)
