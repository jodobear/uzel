...
## Corpus Check
- 130 files · ~93,028 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1264 nodes · 1810 edges · 178 communities (81 shown, 97 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `254d43f7`
...
Cohesion: 0.47
Nodes (9): cleanup_files(), cleanup_on_exit(), create_owned_temp_file(), create_private_temporary_directory(), extract_bounded_entry_scalar(), infrastructure_failure(), run_bounded_subprocess(), verify-external-napplet-corpus.sh script (+1 more)
...
Cohesion: 0.70
Nodes (3): assert_cleanup_failure(), private_candidate(), verify-external-napplet-corpus.test.sh script
