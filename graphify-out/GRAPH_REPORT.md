...
## Corpus Check
- 130 files · ~91,503 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1261 nodes · 1800 edges · 176 communities (79 shown, 97 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b6a4a296`
...
Cohesion: 0.11
Nodes (32): canonicalDirectory(), classifyEvidenceReadError(), CorpusVerificationError, DEFAULT_CORPUS_LOCK, descriptorFailure(), exactTag(), EXPECTED_DOMAINS, EXPECTED_EVENT_IDS (+24 more)
