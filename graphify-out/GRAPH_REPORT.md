# Graph Report - uzel-phase-1-v4  (2026-08-12)

## Corpus Check
- 193 files · ~202,777 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2297 nodes · 2927 edges · 256 communities (147 shown, 109 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4712ac66`
...
2. `Phase Details` - 35 edges
3. `UnixClient` - 33 edges
4. `Uzel product and incubation architecture` - 31 edges
5. `Material findings and corrections` - 28 edges
6. `RunnerError` - 24 edges
7. `A5 — mandatory post-M5 whole-system audit` - 24 edges
8. `ClientError` - 22 edges
...
Cohesion: 0.04
Nodes (44): Accepted Napp Candidate Gate, Anti-Patterns to Avoid, Architectural Responsibility Map, Architecture Patterns, Assumptions Log, Baseline Measurement, Bounded MVP Plan Slices, Candidate qualification record (+36 more)
...
### Community 26 - "Phase 01: SLICE-REF-01 — POC Replay & Accepted Napp Seam - Research"
Cohesion: 0.11
...
Cohesion: 0.12
Nodes (16): Agreed Concerns, Agreed Strengths, CodeRabbit Review, Consensus Summary, Critical, Cross-AI Plan Review — Phase 01, Divergent Views, High-Priority Review Inputs (+8 more)

### Community 32 - "audit_docs.py"
Cohesion: 0.29
Nodes (16): audit_fences(), audit_gsd_ingest_projection(), audit_hashes(), audit_links(), audit_pack_symlinks(), audit_policy(), audit_toml(), clean_target() (+8 more)

### Community 33 - "M3 / GSD delivery phases 4, 4.1–4.3 — external signer and deliberate text publication"
Cohesion: 0.12
Nodes (17): Add After Validation (v1.x), Anti-Features (Commonly Requested, Often Problematic), Competitor Feature Analysis, Dependency Notes, Differentiators (Competitive Advantage), External primary sources (verified; MEDIUM confidence through web-search seam), Feature Dependencies, Feature Landscape (+9 more)
...
Cohesion: 0.06
Nodes (32): Context, Decisions, Deferred, Dependencies, Implementation Plan, Out of Scope, Risks, Status (+24 more)

### Community 36 - "README.md"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, D-18 Review Handoff, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Known Stubs (+6 more)
...
Cohesion: 0.13
Nodes (49): CompletedProcess, Namespace, RuntimeError, TemporaryDirectory, approved_reachability(), candidate_argv_ok(), candidate_record(), canonical_record() (+41 more)
...
Cohesion: 0.17
Nodes (11): Blockers and dependencies on Napp, Classification key, Corrected current-phase scope, Evidence status, Explicit out of scope, Facts requiring fresh research, Lane audit, Phase 1 and Milestone Re-audit (+3 more)
...
Cohesion: 0.18
Nodes (10): Configuration reconciliation, Contradictions resolved, Exact next command, Phase 1 v4 reorientation record, Phase map, Planning files changed, Preserved incident evidence, Resolved environment constraint (+2 more)
...
Cohesion: 0.20
Nodes (9): Blockers & Open Items, Decisions Made, Estimated Resource Usage, Files Changed, GSD Session Report, Key Outcomes, Phases Touched, Session Summary (+1 more)
...
### Community 119 - "Key Findings"
Cohesion: 0.22
Nodes (8): Artifacts this phase produces, D-18 candidate handoff and separately authorized ship/review gate, Fixed replay admission identity, Multi-Source Coverage Audit, Phase Goal, Review Feedback Disposition, STRIDE Threat Register — ASVS L1, block high, Trust Boundaries
...
### Community 130 - "01-reorient-current-gsd.md"
Cohesion: 0.22
...
### Community 131 - "02-review-phase-1.md"
Cohesion: 0.22
...
### Community 132 - "03-execute-phase-1.md"
Cohesion: 0.25
...
### Community 133 - "04-post-m5-audit.md"
Cohesion: 0.25
...
### Community 134 - "05-phase-closeout.md"
Cohesion: 0.25
...
### Community 135 - "06-upstream-contribution.md"
Cohesion: 0.25
...
### Community 136 - "07-milestone-learning.md"
Cohesion: 0.25
...
### Community 218 - "Implementation Decisions"
Cohesion: 0.25
Nodes (7): Authority order, Delivery boundaries, Locked architecture invariants, Phase 1: Truthful baseline and execution reset — Context, Phase boundary, Planning and review gates, Preserved incident evidence

### Community 219 - "Pattern Assignments"
Cohesion: 0.25
...
Cohesion: 0.25
Nodes (7): Artifacts this phase produces, Atomic docs-only scope and staging invariant, D-18 candidate handoff and separately authorized ship/review gate, Phase Goal, Review Feedback Disposition, STRIDE Threat Register — ASVS L1, block high, Trust Boundaries

### Community 222 - "Feature Research"
Cohesion: 0.29
...
### Community 223 - "Phase 01 Plan 04: Napp Qualification and Handoff Summary"
Cohesion: 0.29
Nodes (7): ADR-#### — <decision>, Alternatives considered, Consequences, Context, Decision, Evidence, Revisit trigger

### Community 224 - "Requirements: Uzel"
Cohesion: 0.17
Nodes (11): M0 — truthful baseline, M1 — coherent composable Social Home, M2 — local-first offline authoring, M3 — external signer and deliberate text publication, M4.5 — scheduling and cross-domain recovery, M4 — verified static-image attachment, M5 — production-candidate hardening, Programme constraints (+3 more)
...
### Community 230 - "Uzel"
Cohesion: 0.17
Nodes (11): Constraints, Core Value, Current Milestone, Delivery Model, Key Decisions, Locked Architecture, Out of Scope Before A5, Product Outcome (+3 more)

### Community 231 - "Phase Details"
Cohesion: 0.05
Nodes (41): A5 mandatory stop, Overview, Phase 1: Truthful baseline and execution reset, Phase 2.1: Local profile and cached/live text Home (INSERTED), Phase 2.2: Trusted destination policy and bounded resource fetch (INSERTED), Phase 2.3: Isolated raster normalization and resource cache (INSERTED), Phase 2.4: People and Profile guest surface (INSERTED), Phase 2.5: Mediated cross-surface intents (INSERTED) (+33 more)

### Community 232 - "Project State"
Cohesion: 0.18
Nodes (10): Accumulated Context, Blockers and Evidence Gaps, Current Position, Decisions, Exact Next Action, Pending Todos, Project Reference, Project State (+2 more)

### Community 233 - "Coding Conventions"
Cohesion: 0.33
...
### Community 234 - "Testing Patterns"
Cohesion: 0.33
...
### Community 235 - "GSD Session Report"
Cohesion: 0.33
...
### Community 236 - "External Integrations"
Cohesion: 0.40
...
### Community 238 - "Phase 1: SLICE-REF-01 — POC Replay & Accepted Napp Seam - Discussion Log"
Cohesion: 0.40
...
Cohesion: 0.40
Nodes (4): Completed, Continue Phase 1 planning, Hard boundaries, Next action

## Knowledge Gaps
- **1219 isolated node(s):** `name`, `private`, `version`, `type`, `dev:web` (+1214 more)
...
- **Why does `UnixClient` connect `UnixClient` to `main.rs`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `LinuxRunner` connect `LinuxRunner` to `UnixClient`, `runner.rs`, `EventBuffer`, `.forward_from_surface`, `reconcile_launched_session`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
