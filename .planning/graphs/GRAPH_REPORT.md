...
## Corpus Check
- 147 files · ~112,682 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1489 nodes · 2474 edges · 123 communities (95 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2ed93b19`
...
Cohesion: 0.09
Nodes (43): Response, active_daemon_socket_is_not_unlinked(), AssetTransfer, bounded_detail(), daemon_routes_inc_delivery_to_the_other_exact_surface(), daemon_serves_ordered_verified_asset_and_shuts_down(), DaemonServer, DaemonState (+35 more)
...
Cohesion: 0.15
Nodes (12): Accepted behavior and evidence, Active authority, Canonical References, Deferred Ideas, Delivery, Existing Phase 1 evidence, Implementation Decisions, Napp seam (+4 more)
...
## Knowledge Gaps
- **568 isolated node(s):** `name`, `private`, `version`, `type`, `dev:web` (+563 more)
...
- **Why does `LinuxRunner` connect `LinuxRunner` to `UnixClient`, `server.rs`, `runner.rs`, `.open_configured`, `.forward_from_surface`, `RunnerError`, `EventBuffer`, `String`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `linux_resource_provider()` connect `resource.rs` to `.open_configured`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `NappletReview` connect `UnixClient` to `main.rs`, `LinuxRunner`, `server.rs`, `String`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
