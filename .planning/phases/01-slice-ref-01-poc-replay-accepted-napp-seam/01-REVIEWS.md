...
1. **01-04, candidate probe execution — arbitrary command risk** (`01-04-PLAN.md:97`)
...
2. **Canonical inventory serialization missing** (`01-01-PLAN.md:106-110`)
...
3. **Renderer coverage not derived from baseline config** (`01-01-PLAN.md:117-140`)
...
4. **Environment capture may leak secrets** (`01-01-PLAN.md:140`)
...
5. **Summary/output contradiction** (`01-01-PLAN.md:190-196`)
...
6. **Work 07 status record under-specified** (`01-01-PLAN.md:158-160`)
...
7. **Native and relocated artifacts can collide** (`01-01-PLAN.md:134`)
   Give native and relocated smoke invocations distinct artifact/evidence directories, especially under `--mode all`.

8. **Harness provenance bootstrap unresolved** (`01-01-PLAN.md:136-142`)
...
9. **Deadlines/cancellation not machine-defined** (`01-01-PLAN.md:134-140`)
...
10. **Command-discovery pattern incomplete** (`01-01-PLAN.md:35-43`)
...
11. **Measurement extractor is not executable** (`01-02-PLAN.md:159-163`)
...
12. **Summary/output contradiction** (`01-02-PLAN.md:195-207`)
...
13. **Raw-path confinement is not symlink-safe** (`01-02-PLAN.md:135,159-163`)
...
14. **Committed baseline references ignored evidence** (`01-02-PLAN.md:100-108,159-163`)
...
15. **One-active-profile boundary not enforced** (`01-02-PLAN.md:23-25,157-164`)
    Record profile identity and active-profile count; fail closed unless exactly one active read profile is observed.

16. **Locked-shell provenance is self-reported** (`01-02-PLAN.md:157-163`)
...
17. **Staging boundary not verified** (`01-03-PLAN.md:196-202`)
...
18. **Threat-model deny checks absent** (`01-03-PLAN.md:164-168`)
...
19. **[MINOR] Authority provenance incomplete** (`01-03-PLAN.md:124,212-213`)
    Record every proposed root input, selected or non-normative, with before/after SHA-256 and Git tracked/untracked state.

20. **Auditor result/scope contract under-verified** (`01-03-PLAN.md:165-169`)
...
21. **Issue/PR template checks are text-only** (`01-03-PLAN.md:145-149`)
...
22. **Authority acceptance criteria under-proved** (`01-03-PLAN.md:124-129`)
...
23. **Plan 01-02 dependency missing** (`01-03-PLAN.md:5-7`)
...
24. **Required YAML parsing may fail open** (`01-03-PLAN.md:164-168`)
...
25. **Plan 03 dependency absent** (`01-04-PLAN.md:5-6`)
...
26. **Parity matrix handoff not bound** (`01-04-PLAN.md:108-114`)
...
27. **Handoff equality checks are text-only** (`01-04-PLAN.md:115-118`)
...
28. **Candidate validator does not prove reachability/completeness** (`01-04-PLAN.md:98-101`)
...
29. **Repository mutation check is incomplete** (`01-04-PLAN.md:116-118`)
...
30. **Candidate instructions read mutable working tree** (`01-04-PLAN.md:88-97`)
...
31. **Redaction gate incomplete** (`01-05-PLAN.md:25,95-100,123-125`)
...
32. **Acceptance schema is under-verified** (`01-05-PLAN.md:98-102,121-137`)
...
33. **Failure path can skip cleanup** (`01-05-PLAN.md:95-102`)
